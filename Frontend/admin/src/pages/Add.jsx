...
const Add = ({ token }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // It will add only that image which is present to add.
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        ...
        <div>
          <p onChange={(e) => setPrice(e.target.value)} className="mb-2 ">
            Product Price
          </p>
          <input
      ...
      <div className="flex gap-2 mt-2 ">
        <input
          ...
          id="bestseller"
        />
        <label className="curser-pointer" htmlFor="bestseller">
          Add to bestseller
        </label>
      </div>
